#Question 1
def TowerOfHanoi(n , from_disk, to_disk, middle_disk):
	if n == 0:
		return
	TowerOfHanoi(n-1, from_disk, middle_disk, to_disk) 
               # Move subproblem of n - 1 disk
	print("Move disk",n,"from disk",from_disk,"to disk",to_disk) 
               # Move disk n
	TowerOfHanoi(n-1, middle_disk, to_disk, from_disk) 
               # Move subproblem of n - 1 disk 
n = 3
...
student1 = Student("sumit", 21104012)
